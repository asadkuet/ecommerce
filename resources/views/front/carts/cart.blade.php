                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row hidden-xs hidden-sm" style="height: 40px;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Image</b></div>
                                </div>
                            </div>
                        ...
                        <table class="table table-striped">
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning" align="right">{{config('cart.currency')}} {{ $shippingFee }}</td>
                                </tr>
                                @endif
                                <tr>
                                    ...
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning" align="right">{{config('cart.currency')}} {{ $tax }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="bg-success"></td>
                                    <td class="bg-success"></td>
                                    <td class="bg-success" align="right">{{config('cart.currency')}} {{ number_format($total, 2, '.', ',') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <hr>
